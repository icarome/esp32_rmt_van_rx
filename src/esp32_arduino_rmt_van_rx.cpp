...
void ESP32_RMT_VAN_RX::Init(uint8_t channel, uint8_t rxPin, VAN_LINE_LEVEL vanLineLevel, VAN_NETWORK_TYPE vanNetworkType)
{
    rmt_van_rx_channel_init(channel, rxPin, static_cast<RX_VAN_LINE_LEVEL>(vanLineLevel), static_cast<RX_VAN_NETWORK_TYPE>(vanNetworkType));
}
